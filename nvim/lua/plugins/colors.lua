			...
			require("catppuccin").setup({
				...
				color_overrides = {
					mocha = {
						...
						-- accents (mapped from tokyonight) [web:367]
						red = "#f7768e",
						maroon = "#f7768e",
						peach = "#ff9e64",
						yellow = "#e0af68",
		...
		config = function()
			require("lualine").setup({
				options = {
					...
					section_separators = "", -- Optional: adjust separators as desired
					component_separators = "", -- Optional: adjust separators as desired
